...
- [ ] Документ договору містить серед інших наступні поля (🔎 - поля по яким можливий пошук):
	- [x]  🔎 `Назва документу`
	- [x]  🔎 `Ініціатор документу`
	- [x]  🔎 `Відповідальний юрист`
	- [x]  🔎 `Номер документу внутрішній` — задається автоматично
	- [x]  🔎 `Номер документу зовнішній` — задається юристом
	- [x]  🔎 `Діє до` (дата/час) — може бути пустою для втутрішніх договорів, для зовнішніх рік з
	- [x]  🔎 `Статус документу` — `🎲 Чернетка`, `🎲 На погодженні`, `🎲Не погоджено`, `🎲 Погоджено`, `🎲 Не дійсний`
	- [x]  🔎 `Наша компанія`
	- [x]  🔎 `Контрагент`
	- [x]  🔎 `Реєстраційний код контрагента` (ЕДРПО, ІНН, тощо)
	- [x]  🔎 `Предмет договору`
	- [x]  🔎 `Тип договору` — Внутрішній, Продажі, Закупки, Кредити 
