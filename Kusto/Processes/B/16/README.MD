...
||`     ✏️❗`| Ціна </br> `Price` | Дробне число </br> `Double` |  |
...
|⛔|| `🧰 10 🧩` Кількість </br> `BI_Amount` | Дробне число </br> `Double` | Не використовувати |
|⛔|| `🧰 10 🧩` Сума </br> `BI_Sum` | Дробне число </br> `Double` | Не використовувати |
