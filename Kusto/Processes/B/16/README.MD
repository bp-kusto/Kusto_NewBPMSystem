...
|🚧| Тип і підстава договору </br> `ContractKindAndBasement` | [📘 Тип і підстава договору (Объект)](../../../Entities/.md) </br> `🚧` | False |
...
|🚧| Підстава. Службова записка </br> `Base_ServiceNote` | 📕 [Служебная записка (Документ)](../../../Documents/.md) </br> `🚧` | False |
